 ...
 * All values are production-ready and WCAG AA compliant
 */

export const designTokens = {
  // Colors
  colors: {
    // Primary - Blue (Trust, Travel, Sky)
    primary: {
      50: '#eff6ff',
      100: '#dbeafe',
      200: '#bfdbfe',
    ...
    // Secondary - Amber (Discovery, Energy, Adventure)
    secondary: {
      50: '#fffbeb',
      100: '#fef3c7',
      200: '#fde68a',
  ...
  // Typography Scale (using default HTML elements, no custom classes)
  typography: {
    // Font Families
    fontFamily: {
    ...
    // Font Sizes (handled by CSS, not Tailwind classes)
    // See globals.css for h1-h6, p, etc.
  },
...
// Export individual token sets for convenience
