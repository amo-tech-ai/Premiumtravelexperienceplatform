        ...
        <TabPanel id="trips" isActive={activeTab === 'trips'}>
          <div className="p-4 space-y-3">
            <div className="flex items-center justify-between mb-3">
              ...
              <Badge variant="secondary" className="bg-slate-100 text-slate-600 text-xs">Coming soon</Badge>
            </div>

            {/* Empty state for trips */}
            <div className="text-center py-12">
              <Luggage className="w-12 h-12 text-slate-300 mx-auto mb-3" />
              <p className="text-sm text-slate-600 mb-1">No trip plans yet</p>
              <p className="text-xs text-slate-500">Ask me to plan your perfect day in Medellín</p>
            </div>
          </div>
        </TabPanel>
