/**
 * How It Works - Tablet Layout (768px - 1023px)
 * Simplified vertical scroll with reduced motion
 * Side-by-side text + screenshot when space allows
 */
...
function TabletStep({ step, title, description, children, reverse = false }: TabletStepProps) {
  return (
    <motion.div
...
export function HowItWorksTablet() {
  return (
    <div className="space-y-20 px-6 py-16">
      ...
      >
        <div className="space-y-5">
          <h4 className="text-xl font-bold text-slate-900">Exploring El Poblado</h4>
      ...
      >
        <div className="space-y-5">
          <h4 className="text-xl font-bold text-slate-900">Tonight in Laureles</h4>
          ...
          <div className="bg-white rounded-xl p-5 border border-emerald-200 shadow-sm">
            <div className="flex gap-3">
              <div className="w-20 h-20 bg-gradient-to-br from-emerald-100 to-emerald-50 rounded-lg flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="font-bold text-base text-slate-900 mb-1">Jazz Night @ Alambique</p>
                <p className="text-sm text-slate-600 mb-2">⏰ 8:00 PM · 1.5km</p>
      ...
      >
        <div className="space-y-5">
          <h4 className="text-xl font-bold text-slate-900">Stays in Envigado</h4>
          ...
          <div className="bg-white rounded-xl overflow-hidden border border-emerald-200 shadow-sm">
            <div className="h-28 bg-gradient-to-br from-emerald-100 to-emerald-50" />
            <div className="p-4">
      ...
      >
        <div className="space-y-5">
          <div>
            <h4 className="text-xl font-bold text-slate-900">Saturday in Medellín</h4>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs text-amber-900">
                <span className="font-semibold">AI:</span> Save 18 min
              </p>
            </div>
          </div>
